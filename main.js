    ...
    card.innerHTML = `
        ...
        <div style="padding:1.5rem;display:flex;flex-direction:column;flex:1;gap:0.75rem;">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:auto;padding-top:0.5rem;">
                <span style="background:rgba(255,255,255,0.07);color:#e2e8f0;font-size:0.92rem;font-weight:700;padding:5px 12px;border-radius:6px;display:flex;align-items:center;gap:6px;">
